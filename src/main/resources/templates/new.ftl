...
<@common.Outline title="새 글 작성">
    ...
    <form class="form-control" onsubmit="return false;">
        ...
        <textarea type="text" name="content" id="content" class="form-control noresize" rows="25"></textarea>
        <#if hasNoticeAuth>
        ...
        <div class="input-group mt-2">
            <button class="btn btn-success" id="add-button" type="button">등록</button>
        </div>
    </form>
    <script>
        (function() {
            ...
            addButton.onclick = function (e) {
                if (validateForm()) {
                    ...
                    axios.post('/api/documents', params)
                        .then(res => res.data)
